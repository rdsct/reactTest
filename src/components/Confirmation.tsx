    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-pink-700 to-pink-500">
      <div className="flex-1 p-4">
        <div className="w-full max-w-md mx-auto">
          <button
            onClick={() => navigate('/add-names', { state: { playerNames, rounds } })}
          ...
          <div className="flex flex-col items-center justify-center gap-8">
            <div className="text-center space-y-4">
              <p className="text-white text-xl">{translations.readyToPlay}</p>
              <p className="text-white text-4xl font-bold">
                {playerNames.length}{' '}
                {playerNames.length === 1 ? translations.player : translations.players_plural}
              </p>
              <p className="text-white text-2xl">
                {rounds} {translations.rounds_count}
              </p>
            </div>

            <button
              onClick={() => navigate('/game', { state: { playerNames, rounds } })}
